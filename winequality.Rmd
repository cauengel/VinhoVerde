...
Analisando a tabela acima, nota-se que os três primeiros componentes já contribuem para mais de 92% da variancia da base.
Mediante a constatação, criou-se três novos atributos pca1, pca2 e pca3 correspondendo ao primeiro, segundo e terceiro componentes do PCA.
...
print("Modelo com regressão linear aplicada sobre o modelo com PCA - treinamento")
...
print("Modelo com regressão linear aplicada sobre o modelo com PCA - teste")
...
print("Modelo de regressão linear aplicada sobre o modelo sem PCA - treinamento")
result <- testa.modelo(modelo=modelo1, valores_observados=treinamento_semPCA$quality, tit_grafico = "Linear Completo - treino")


# Modelo com os dados completos sem transformação  PCA - teste
print("Modelo de regressão linear aplicada sobre o modelo sem PCA - teste")
...
#Árvore de Regressão com a aplicação de PCA
library(rpart.plot)
library(rpart)
...
#Árvore de Regressão sem a aplicação de PCA
